...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    const toastIdLogOut = toast.loading("Loading...");
    try {
      await logout();
  ...
  return (
    <nav className="navbar sticky top-0 z-10 bg-slate-200 shadow-lg dark:bg-slate-900 lg:pr-3">
      <div className="flex-1">
        <Link
          href="/"
          className="btn-ghost btn text-2xl normal-case text-[#209CEE]"
        >
          e Shop
        </Link>
      </div>
            ...
            <label tabIndex={0} className="btn-ghost btn-circle avatar btn">
              <div className="w-10 rounded-full">
                <Image
                  ...
                  src={
                    photoURL ||
                    "https://i.ibb.co/R23Sc33/profile-Image-Holder.jpg"
                  }
                  width={40}
                  height={40}
